...
class DifferTest extends TestCase
{
    ...
    {
        $this->assertEquals(
            trim($this->expectedStylish),
            trim(genDiff($this->pathToJsonFile1, $this->pathToJsonFile2, 'stylish'))
        );
    }
    ...
    public function testCalculateDifferenceYmlForStylish(): void
    {
        $this->assertEquals(
            trim($this->expectedStylish),
            trim(genDiff($this->pathToYmlFile1, $this->pathToYmlFile2, 'stylish'))
        );
    }
    ...
    public function testCalculateDifferenceDefault(): void
    {
        $this->assertEquals(
            trim($this->expectedStylish),
            trim(genDiff($this->pathToJsonFile1, $this->pathToJsonFile2))
        );
        $this->assertEquals(
            trim($this->expectedStylish),
            trim(genDiff($this->pathToYmlFile1, $this->pathToYmlFile2))
        );
    }
    ...
    {
        $this->assertEquals(
            trim($this->expectedPlain),
            trim(genDiff($this->pathToJsonFile1, $this->pathToJsonFile2, 'plain'))
        );
    }
    ...
    public function testCalculateDifferenceYmlForPlain(): void
    {
        $this->assertEquals(
            trim($this->expectedPlain),
            trim(genDiff($this->pathToYmlFile1, $this->pathToYmlFile2, 'plain'))
        );
    }
    ...
    public function testCalculateDifferenceYmlForJson(): void
    {
        $this->assertJsonStringEqualsJsonFile(
            ($this->expectedJson),
            (genDiff($this->pathToYmlFile1, $this->pathToYmlFile2, 'json'))
        );
    }
